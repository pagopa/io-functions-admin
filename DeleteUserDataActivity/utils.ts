...
export enum CosmosErrorsTypes {
  "OSMOS_EMPTY_RESPONSE" = "OSMOS_EMPTY_RESPONSE",
  "OSMOS_CONFLICT_RESPONSE" = "OSMOS_CONFLICT_RESPONSE",
  "OSMOS_DECODING_ERROR" = "OSMOS_DECODING_ERROR",
  "OSMOS_ERROR_RESPONSE" = "OSMOS_ERROR_RESPONSE"
}
